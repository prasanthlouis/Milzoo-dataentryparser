...
mypath="C:\Users\Prasanth\Desktop\journal14\part1\\"
...
select_box =driver.find_element_by_name("article_author[]")
...
for element in options: 
	f = open('listofauthors.txt','a')
	f.write(element.get_attribute("text")+'\n') # python will convert \n to os.linesep
	f.close() 
